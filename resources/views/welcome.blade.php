...
<body data-bs-spy="scroll" data-bs-target="#navbarExample">
    ...
    <nav id="navbarExample" class="navbar navbar-expand-lg fixed-top navbar-light" aria-label="Main navigation">
        <div class="container">
            ...
            <!-- Image Logo -->
            {{-- <a class="navbar-brand logo-image" href="index.html"><img src="{{ asset('zinc') }}/images/logo.svg"
            alt="alternative"></a> --}}
                        ...
                        <div class="swiper-container card-slider">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="quotes" src="{{ asset('zinc') }}/images/quotes.svg"
                                            alt="alternative">
                                        <div class="card-body">
                                            <p class="testimonial-text">Fusce tincidunt dui nec diam varius venenatis.
                                                Nullam tristique rutrum odio, ut tincidunt erat dictum in. Etiam et
                                                aliquet mi, et vehicula elit fusce porta ullamcorper</p>
                                            <div class="details">
                                                <img class="testimonial-image"
                                                    src="{{ asset('zinc') }}/images/testimonial-1.jpg"
                                                    alt="alternative">
                                                <div class="text">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="quotes" src="{{ asset('zinc') }}/images/quotes.svg"
                                            alt="alternative">
                                        <div class="card-body">
                                            <p class="testimonial-text">Mauris ut mattis nisl. Nunc ultrices nisi eget
                                                nisl pulvinar iaculis vitae ac nulla. Nullam fringilla varius blandit.
                                                Nam sit amet eleifend justo blogo rovan de chichis kokos venir dab</p>
                                            <div class="details">
                                                <img class="testimonial-image"
                                                    src="{{ asset('zinc') }}/images/testimonial-2.jpg"
                                                    alt="alternative">
                                                <div class="text">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p class="testimonial-text">Nam sit amet eleifend justo. Aliquam sit amet
                                                lacinia enim, eget facilisis ex. Ut pretium cursus eleifend. Integer
                                                feugiat malesuada quam vel basil venis proca jilo</p>
                                            <div class="details">
                                                <img class="testimonial-image"
                                                    src="{{ asset('zinc') }}/images/testimonial-3.jpg"
                                                    alt="alternative">
                                                <div class="text">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="quotes" src="{{ asset('zinc') }}/images/quotes.svg"
                                            alt="alternative">
                                        <div class="card-body">
                                            <p class="testimonial-text">Lorem ipsum dolor sit amet, consectetur ing
                                                elit. Nulla id nisl tempus risus facilisis efficr ut tincidunt vitae
                                                enim non vehicula. Phases vitae metus in felis gravida ultrices zimbo
                                            </p>
                                            <div class="details">
                                                <img class="testimonial-image" /
                                                    src="{{ asset('zinc') }}images/testimonial-4.jpg" alt="alternative">
                                                <div class="text">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title">
                                <img class="decoration-lines" src="{{ asset('zinc') }}/images/decoration-lines.svg"
                                    alt="alternative"><span>Landing page</span><img class="decoration-lines flipped"
                                    src="{{ asset('zinc') }}/images/decoration-lines.svg" alt="alternative">
                            </div>
                            <ul class="list-unstyled li-space-lg">
